...
//    val test3 = "@test#美食推薦#餐廳推薦 @beefnoodle@testing123@西班牙海鮮燉飯@西班牙大鍋飯@tapas@相機先食@伊比利豬#paella#美食日記#台北美食#大安站美食#信義安和站美食"
...
//    val result = regex.findAll(test3).toList().map {
//        it.value
//    }.joinToString(separator = " ").replace("[^\\s-]#".toRegex()) {
//        it.value[0].toString() + " #"
//    }
...
//}
//
//private fun tempNull(): Unit? = null